...
class Antenna_Snapshot(EmbeddedDocument):
    ...
    lfI_X = DictField(default=make_a_day(0.0)) # also in the logLF_X file
    lfQ_X = DictField(default=make_a_day(0.0)) # also in the logLF_X file
    lfI_Y = DictField(default=make_a_day(0.0)) # also in the logLF_Y file
    lfQ_Y = DictField(default=make_a_day(0.0)) # also in the logLF_Y file
