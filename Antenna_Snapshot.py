...
class Antenna_Snapshot(EmbeddedDocument):
    ...
    intswX = StringField(default="DATA") # also in the logCorr_X file
    hybrid_selX = StringField(default="DATA") # also in the logCorr_X file
    ...
    intswY = StringField(default="DATA") # also in the logCorr_Y file
    hybrid_selY = StringField(default="DATA") # also in logCorr_Y
